...
public class JexoPlayerView2 extends StyledPlayerView {
    ...
    private void init() {
        ...
        if (fullscreenButton != null) fullscreenButton.setColorFilter(0xffffffff);

        setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Utils.toast(getContext(), "yuhuuu");
            }
        });
        ...
        settingIcons[SETTINGS_VIDEO_POSITION] = button != null ? button.getDrawable() : resources.getDrawable(R.drawable.speed);
    ...
    public JexoPlayerView2(Context context) {
        super(context);
        init();
    }

    public JexoPlayerView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public JexoPlayerView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
