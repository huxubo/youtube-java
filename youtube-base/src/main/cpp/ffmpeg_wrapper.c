...
Java_com_jschartner_youtubebase_Ffmpeg_mergeVideoAudio(JNIEnv *env, jclass clazz, jstring video_path,
...
JNIEXPORT jstring JNICALL
Java_com_jschartner_youtubebase_Ffmpeg_getVideoCodec(JNIEnv *env, jclass clazz, jstring filepath) {
...
JNIEXPORT jstring JNICALL
Java_com_jschartner_youtubebase_Ffmpeg_transcodeToMp3(JNIEnv *env, jclass clazz, jstring input_path,
                                                  jstring output_path) {
